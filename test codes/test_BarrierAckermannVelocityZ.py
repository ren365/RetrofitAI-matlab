...
cbf=BarrierAckermannVelocityZ(bound_from_above=True, v_lim = 2.0, gamma=10.0)
x = np.zeros((5,4))
x[0,0]=0.1
x[1,0]=0.2
x[2,0]=0.3
x[3,0]=0.4
x[4,0]=0.5
print(cbf.get_B_derivatives(x[:,0:1]))

cbf=BarrierAckermannPointZ(x=3,y=5, radius=1.0, gamma_p=5.0, gamma=1.0)
print(cbf.get_B_derivatives(x[:,0:1]))
