...
plt.legend(('ad(1)','balsa(1)','ad(2)','balsa(2)'),bbox_to_anchor=(0,1.2,1,0.2), loc="upper center", ncol=2)
...
plt.legend(('ad','qp','pd','balsa'),bbox_to_anchor=(0,1.1,1,0.2), loc="upper center", ncol=4)
...
plt.legend(('ad','qp','pd','balsa','barrier'),bbox_to_anchor=(0,1.2,1,0.2), loc="upper center", ncol=5)
# plt.ylim((0,1.0))
plt.subplot(312)
plt.plot(t,x_d(3,:),'k-')
